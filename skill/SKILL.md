...
description: >-
  ...
  for a local business website homepage. Produces a complete 5-block JSON-LD schema
  (WebPage, Service, LocalBusiness, Article, Place) mirroring the 75degreeac.com
  advanced schema pattern. Includes driving direction Maps, GeoCircle areaServed,
  postal code Map entries, TouristAttraction mentions, knowsAbout entities,
  and Google Maps CID integration.
---

# Home Page Schema Builder

This skill builds a **5-block advanced JSON-LD schema** for any local business homepage.
...
5. Each service page for description content

NOTE: If a page returns 404, exclude it from relatedLink and offers.

---

## 5-Block Schema Structure
...
- No duplicate Map entries (verify with: (Select-String -Pattern "How to reach us from").Count)
...
- locationCity anchor is all lowercase
...
Master template file: 75degreeac_houston_schema.html
Completed example: happyhomes_sacramento_schema.html
Both located at: C:\Users\BlueJayPro\.gemini\antigravity-ide\brain\7b890ccf-f352-48f6-b14d-ebab1fa043af\
